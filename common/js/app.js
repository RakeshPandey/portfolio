...
let modalData = [
	{
		...
		content: `In today’s world, the digital landscape has evolved rapidly and the user requirements are much more cleared. Methods and techniques are developed to help the end-users to find the right product, services, better experiences, and get it simply and as quickly as possible. To achieve a high-quality user experience, the companies are followed the approach called <strong>design thinking</strong>.
			<p>Design thinking is the process to help the organizations to solve the problems creatively and innovatively and it is not the sole property of designers or UX researchers, all great leaders in the field of literature, art, music, science, engineering, and business have exercised it. Design thinking is an iterative process to understand the user, analyze the user's problem, and provide solutions to our end users. Brands like Apple, Adobe, Google, Adidas, and GE have rapidly adopted the design thinking to provide the best user experience to their end-users.  There are five different phases of design thinking:</p> 
			<ul>
				<li>Empathize – with your users</li>
				<li>Define – your users’ needs, their problem, and your insights</li>
				<li>Ideate – by challenging assumptions and creating ideas for innovative solutions</li>
				<li>Prototype – to start creating solutions</li>
				<li>Test – solutions</li>
			</ul>
			<div><img src="common/images/design_thinking.png" alt="Design Thinking - develop an idea" width="100%" /></div>
		`
	},
	{
		title: "Market Research",
		content: `<p>Market Research and Design Thinking are two different approaches but share the common goal. Both approaches focus on the customers and their needs and creating solutions from the users ‘ perspective as well as supporting companies in developing customer-centric products and services. Companies like Coca-Cola, Apple, Nike, IBM, Whirlpool, and Procter & Gamble are all design-led companies.  Because of the extraordinary success rate of these corporations, the design has progressed beyond making objects. Organizations now want to learn how to think like designers and employ design principles in their workplaces.</p>
			<p>Market research has many techniques to gather data but the most important one is usability testing with a real user. Usability testing is the process to evaluate the web or mobile application and to figure out whether the website is ready to launch for the end-users. It is the process to identify the performance of the website, application, product, or service by the end-user by asking to perform specific tasks. Users are not directed or controlled by anyone at the time of testing or interview so that the research team gets the relevant feedback from the user without any biased. This also helps to understand how intuitive and comfortable is the product for the end-users.</p>
	...
	// },
	{
		...
		content: `<p>A User Journey map is a visual representation of the customer journey to identify the path taken by a user to achieve specific goals. It is the most important UX tool to analyze how a user interacts with a product and allows the research team to understand the user journey from the user’s point of view.</p>
			...
			<div><img src="common/images/documents/customer_journey_map.jpg" alt="Customer Journey Map" width="100%" /></div>
			<p>Xtensio, a web application can be used to make User Personas. You can also create one using Figma. 
				<a href="common/images/documents/customer_journey_map.jpg" target="_blank" Customer Journey Map">View file Here.</a>
			</p>
		`
	},
	{
